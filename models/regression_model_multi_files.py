...
# Load multiple training files
file_paths = glob.glob("path/to/training/files/*.csv")
...
df[['iris_1', 'iris_2', 'iris_3', 'iris_4']] = df[['iris_1', 'iris_2', 'iris_3', 'iris_4']] / waveguide_width
X = df[['iris_1', 'iris_2', 'iris_3', 'iris_4', 'real', 'imag']]
df['error'] = np.log1p(df['error'])
y = df[['error']]
