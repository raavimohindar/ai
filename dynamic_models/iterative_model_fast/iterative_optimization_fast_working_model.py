...
data_directory = r"D:\Development\waveguide_ai\wizard_projects\csv_files"  # Path where the 600 training files are stored
...
def show_error_regions_first(design_test, s11_predicted, s11_true, method, error_threshold=0.1):
...
for iteration in range(5):
    ...
    show_error_regions_first(design_test, s11_real_predicted, s11_real_test, "Fast - AMG Interpolation (Real)", error_threshold)
    show_error_regions_first(design_test, s11_imag_predicted, s11_imag_test, "Fast - AMG Interpolation (Imag)", error_threshold)
